...
def dijkstra(gridmap,height, width, agentx,agenty, scoredij,traps,character):
  ...
  while not pq.empty():
      ...
      if (current_nodey - 1 >= 0) and ((current_nodex , current_nodey-1) not in visited) and (
         (gridmap[current_nodex][current_nodey-1] == 'E') or (gridmap[current_nodex][current_nodey-1] == 'T')or(gridmap[current_nodex][current_nodey-1]=="E"+character) or (gridmap[current_nodex][current_nodey-1]=="T"+character) or (gridmap[current_nodex][current_nodey-1] == '1' and scoredij-1 < 0) or (
